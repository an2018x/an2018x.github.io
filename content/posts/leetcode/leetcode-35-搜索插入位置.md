...
实验编号/标题：例如：实验-leetcode-35-搜索插入位置
...
![](https://an-img.oss-cn-hangzhou.aliyuncs.com/2026/02/26/20260226232924068.png)
...
mid 和他左边的都不可能是答案，left = mid + 1

nums[mid] >= target

mid 可能就是答案，但是左边可能有更早的满足条件的位置。
