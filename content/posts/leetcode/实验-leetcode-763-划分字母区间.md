...
实验编号/标题：例如：实验-leetcode-763-划分字母区间

日期：Feb 27, 2026

所属领域/标签：例如：#LeetCode #贪心
...
![](https://an-img.oss-cn-hangzhou.aliyuncs.com/2026/02/27/20260227213231593.png)
...
一个片段的右边界，至少要覆盖这个片段内所有字符的最后出现位置中的最大值。
