...
实验编号/标题：例如：实验-leetcode-74-搜索二维矩阵
...
![](https://an-img.oss-cn-hangzhou.aliyuncs.com/2026/02/27/20260227104009455.png)

## 实验目标 (Objective)：做完这件事，我想达到什么具体效果？

在一个隐式的一维展开数组中查找 target。

## 核心假设 (Hypothesis)：（最关键的一步） 我认为怎么做能成功？

整个矩阵的角度是全局有序的，可以通过二分来解决。

细节：需要维护一维矩阵到二维矩阵之间的映射关系。
