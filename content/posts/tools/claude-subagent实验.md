...
2. 准备文件
    ...
    test_calculator.py
    ```python
    from calculator import divide, average, is_even
...
3. 创建 code-reviewer agent
    * ![](https://an-img.oss-cn-hangzhou.aliyuncs.com/2026/03/17/20260317224916257.png)
    * ![](https://an-img.oss-cn-hangzhou.aliyuncs.com/2026/03/17/20260317225022271.png)
4. 验证 sub agent
    * ![](https://an-img.oss-cn-hangzhou.aliyuncs.com/2026/03/17/20260317225411221.png)
