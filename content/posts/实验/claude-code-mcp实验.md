...
1. 添加远程 HTTP MCP server

    https://github.com/MicrosoftDocs/mcp?utm_source=chatgpt.com

    ```bash
    claude mcp add --transport http <server_name> <server_url>
    ```
    ![](https://an-img.oss-cn-hangzhou.aliyuncs.com/2026/03/17/20260317230852513.png)
2. 查看 mcp 服务
    ![](https://an-img.oss-cn-hangzhou.aliyuncs.com/2026/03/17/20260317230923078.png)
3. 调用 MCP 工具
    ![](https://an-img.oss-cn-hangzhou.aliyuncs.com/2026/03/17/20260317231056539.png)
